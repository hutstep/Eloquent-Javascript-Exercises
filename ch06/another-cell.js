...
StretchCell.prototype.minWidth = function() {
  var innerMinWidth = this.inner.minWidth();
  return innerMinWidth >= this.width ? innerMinWidth : this.width;
};
StretchCell.prototype.minHeight = function() {
  var innerMinHeight = this.inner.minHeight();
  return innerMinHeight >= this.height ? innerMinHeight : this.height;
};
